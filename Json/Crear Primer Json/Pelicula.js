...
function Pelicula (nombre, director, year, tipo){
	...
	Pelicula.prototype.toJSONObject = function (){
		...
		jPelicula.nombre = this.nombre;
		jPelicula.director = this.director;
		jPelicula.year = this.year;
		jPelicula.tipo = this.tipo;
		jPelicula.prestado = this.prestado;
		jPelicula.prestatario = this.prestatario;
